...
public class HoaDonRepositoriesImpl implements HoaDonRepository{
    ...
    @Override
    public List<HoaDon> getHoaDonByDonHang(DonHang dh) {
        throw new UnsupportedOperationException("Not supported yet."); // Generated from nbfs://nbhost/SystemFileSystem/Templates/Classes/Code/GeneratedMethodBody
    }

    @Override
    public List<HoaDon> getHoaDonByDate(LocalDateTime ngayLap) {
        throw new UnsupportedOperationException("Not supported yet."); // Generated from nbfs://nbhost/SystemFileSystem/Templates/Classes/Code/GeneratedMethodBody
    }
    ...
    @Override
    public List<HoaDon> getHoaDonByTongTien(BigDecimal tongTien) {
        throw new UnsupportedOperationException("Not supported yet."); // Generated from nbfs://nbhost/SystemFileSystem/Templates/Classes/Code/GeneratedMethodBody
    }
